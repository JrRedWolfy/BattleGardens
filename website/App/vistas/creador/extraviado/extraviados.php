...
<div id="leyend_panel">
  ...
  <div class="creation_btn">
    <button class="new_elmn_btn"><a href="<?php echo RUTA_URL?>/arquitecto/add_extraviado"><i class="fa fa-plus"></i> Nuevo Extraviado</a></button>
  </div>
      ...
      <div class="modal-body">
        ...
        <div class="options_panel">
          ...
          <div id=autor_area>
            ...
            <button class="filter_button" onclick="toggleFilter('<?php echo $autor->autor?>',2, 'autor_border')"><?php echo $autor->autor?></button>
            <?php endforeach ?>
          </div>
...
<div class="modal fade" id="confirmar_delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo RUTA_URL?>/arquitecto/dismiss_extraviado" method="POST">
...
<script>
  ...
  window.onload=caja_fuerte(<?php echo json_encode($datos["total_extraviados"])?>, <?php echo $datos["usuarioSesion"]->id_rol?>, <?php echo json_encode(RUTA_URL)?>, "extraviado"); // Aqui pasamos el array en cuestion recibido por PHP
