...
<div id="leyend_panel">
  <div class="creation_btn">
    <button class="new_elmn_btn"><a href="<?php echo RUTA_URL?>/arquitecto/add_evento"><i class="fa fa-plus"></i> Nuevo Evento</a></button>
  </div>
...
<div class="modal fade" id="confirmar_delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo RUTA_URL?>/arquitecto/del_extraviado" method="POST">
...
window.onload=caja_fuerte(<?php echo json_encode($datos["total_eventos"])?>, <?php echo $datos["usuarioSesion"]->id_rol?>, <?php echo json_encode(RUTA_URL)?>, "evento"); // Aqui pasamos el array en cuestion recibido por PHP
