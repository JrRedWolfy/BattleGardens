...
<div id="leyend_panel">
  ...
  <div class="creation_btn">
    <button class="new_elmn_btn"><a href="<?php echo RUTA_URL?>/arquitecto/add_artefacto"><i class="fa fa-plus"></i> Nuevo Artefacto</a></button>
  </div>
...
<div id="filter_panel">
  ...
  <!-- Button trigger modal -->
    ...
    <!-- Paginacion -->
    <input disabled id="page_controller" name="artefacto" value="0" hidden>
...
<script>
  ...
  window.onload=caja_fuerte(<?php echo json_encode($datos["total_artefactos"])?>, <?php echo $datos["usuarioSesion"]->id_rol?>, <?php echo json_encode(RUTA_URL)?>, "artefacto"); // Aqui pasamos el array en cuestion recibido por PHP
