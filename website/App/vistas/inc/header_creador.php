...
<div id="menu_arquitecto" class="mv_arq menu_flotante">
  ...
  <div class="content_arquitecto">
    <a href="<?php echo RUTA_URL?>/site/home" class="categoria_arq">Home</a>
    <a href="<?php echo RUTA_URL?>/site/universo" class="categoria_arq">Universo</a>
    <a href="<?php echo RUTA_URL?>/site/comunidad" class="categoria_arq">Comunidad</a>
  </div>
