...
class Uploader {
     ...
     */
    const UPLOAD_DIR = RUTA_APP . '/../public/img/iconos' /* This is an absolute path */;
     ...
     */
    public function upload(array $files = [], $nameGet = "") {
        ...
        foreach ($normalizedFiles as $normalizedFile) {
            $uploadResult = $this->uploadFile($normalizedFile, $nameGet);
     ...
     */
    private function uploadFile(array $file = [], $nameGet = "") {
        $name = $nameGet.".jpg"; /*Voy a cambiar el nombre por aquel que haya en el input de nombre, original: $file['name']*/
        $type = $file['type'];
