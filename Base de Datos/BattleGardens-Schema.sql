...
CONSTRAINT FK12 FOREIGN KEY (id_extraviado) references extraviado (id_extraviado) on delete restrict on update cascade,
CONSTRAINT FK13 FOREIGN KEY (id_juego) references juego (id_juego) on delete restrict on update cascade
);
...
ADD CONSTRAINT FK10 FOREIGN KEY(origen)  
REFERENCES mundo (id_mundo) ON UPDATE CASCADE ON DELETE RESTRICT;
...
CONSTRAINT FK14 FOREIGN KEY(id_progreso)  REFERENCES progreso (id_progreso) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK15 FOREIGN KEY(autor)  REFERENCES usuario (nickname) ON UPDATE CASCADE ON DELETE RESTRICT     
);
...
CONSTRAINT FK16 FOREIGN KEY (id_extraviado) references extraviado (id_extraviado) on delete restrict on update cascade,
CONSTRAINT FK17 FOREIGN KEY (id_historia) references historia (id_historia) on delete restrict on update cascade
);
...
CONSTRAINT FK18 FOREIGN KEY (id_juego, id_extra_det) references extraviado_detalle (id_juego, id_extra_det) on delete restrict on update cascade,
CONSTRAINT FK19 FOREIGN KEY (id_estado) references estado_extra (id_estado) on delete restrict on update cascade
);
...
id_det_evento int primary key, 
contenido varchar(500) not null,
autor varchar(30) not null,
fecha date not null,
id_progreso int not null,

CONSTRAINT FK21 FOREIGN KEY(id_progreso)  REFERENCES progreso (id_progreso) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK22 FOREIGN KEY(autor)  REFERENCES usuario (nickname) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
CONSTRAINT FK23 FOREIGN KEY(id_det_evento)  REFERENCES evento_detalle (id_det_evento) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK24 FOREIGN KEY(id_activador)  REFERENCES activador (id_activador) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK25 FOREIGN KEY (id_tipo_evento) references tipo_evento (id_tipo_evento) on delete restrict on update cascade
);
...
CONSTRAINT FK26 FOREIGN KEY(id_extraviado)  REFERENCES extraviado (id_extraviado) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
CONSTRAINT FK27 FOREIGN KEY(id_tipo_publi)  REFERENCES tipo_publicacion (id_tipo_publi) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK28 FOREIGN KEY(autor)  REFERENCES usuario (nickname) ON UPDATE CASCADE ON DELETE RESTRICT   
);
...
CONSTRAINT FK29 FOREIGN KEY(id_extraviado)  REFERENCES extraviado (id_extraviado) ON UPDATE CASCADE ON DELETE RESTRICT,
CONSTRAINT FK30 FOREIGN KEY(id_conocido)  REFERENCES extraviado (id_extraviado) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
CONSTRAINT FK32 FOREIGN KEY(nickname)  REFERENCES usuario (nickname) ON UPDATE CASCADE ON DELETE RESTRICT   
);
...
CONSTRAINT FK33 FOREIGN KEY (id_requisito) references requisito (id_requisito) on delete restrict on update cascade,
CONSTRAINT FK34 FOREIGN KEY (id_evento) references evento (id_evento) on delete restrict on update cascade
);
...
CONSTRAINT FK35 FOREIGN KEY (id_evento, id_activador) references evento (id_evento, id_activador) on delete restrict on update cascade
);
...
CONSTRAINT FK36 FOREIGN KEY (id_recurso) references recurso (id_recurso) on delete restrict on update cascade,
CONSTRAINT FK37 FOREIGN KEY (id_conclusion) references conclusion (id_conclusion) on delete restrict on update cascade
);
